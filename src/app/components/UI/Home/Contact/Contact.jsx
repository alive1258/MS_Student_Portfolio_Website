          ...
          <div className="mt-16 grid  md:grid-cols-3  grid-cols-1 gap-6">
            ...
            >
              ...
              <div className="p-6">
                ...
                <h2 className="mt-8 text-[20px] font-semibold">Get in Touch</h2>
                <p className="mt-4 text-[16px]">
                  I'm always open to meaningful conversations — whether it's
                  about research, collaboration, or academic support. Feel free
                  to reach out if you have ideas to share, questions to explore,
                  or projects you'd like to discuss.
                </p>
                <div className="mt-6 flex items-center justify-between text-lg">
                  <p className=" border-white/60 border-b">+8801770014882</p>
                  <p className=" border-white/60 border-b">+8613036395261</p>
                </div>
              </div>
            </div>
            {/* card 3  */}
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="mt-4 text-[16px]">
                  I’m always open to research collaborations, guest lectures,
                  joint publications, and academic initiatives. If you’re
                  working on something exciting and think we could work well
            ...
            >
              <div>
                ...
                <p className="mt-5 text-[16px] text-center">
                  Whether you have a question, collaboration idea, or just want
                  to say hello — I’d love to hear from you. Drop a message
                  anytime and I’ll get back to you as soon as possible.
                </p>
                <div>
