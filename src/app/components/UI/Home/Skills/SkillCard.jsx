...
const SkillCard = ({ item }) => {
  return (
    <div className="relative  text-[#fff] overflow-hidden md:w-[424px] w-full p-6    rounded-[24px] border border-white/20 bg-[linear-gradient(234deg,_rgba(199,215,245,0.10)_2.11%,_rgba(14,26,50,0.10)_50.54%,_rgba(210,225,255,0.10)_98.98%)] backdrop-blur-[4.5px]">
      {/* Top Gradient Line */}
      ...
      {/* Category Title */}
      <h1 className="text-2xl font-semibold ">{item?.skillsCategory?.title}</h1>
            ...
            <div className="w-full">
              ...
              <div className="flex space-x-4">
                ...
                <div
                  ...
                  style={{ background: "rgba(1, 5, 13, 0.50)" }}
                >
                  <div
