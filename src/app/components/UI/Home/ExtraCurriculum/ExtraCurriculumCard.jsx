...
const ExtraCurriculumCard = ({ item, delay = 0 }) => {
  return (
    <SlideUp delay={delay}>
      <div className="bg-[#F5F5F4] h-[200px]  border border-[#E0E0E0] hover:shadow-xl transition-all duration-300 ease-in-out p-4 grid md:grid-cols-3 grid-cols-1 gap-x-5 md:gap-y-0 gap-y-4 rounded-2xl">
        {/* START IMAGE SECTION */}
