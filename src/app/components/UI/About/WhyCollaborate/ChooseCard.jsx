...
const ChooseCard = ({ card, delay = 0, index }) => {
  return (
    <SlideUp delay={delay}>
      <div className="relative h-full flex w-full md:max-w-[312px] py-8 px-4 flex-col items-center gap-6 rounded-lg border border-[#27272A] bg-[rgba(39,39,42,0.3)] text-white-base">
        ...
        <p className=" text-[16px] font-medium text-[#D4D4D8]">
          {card.description}
        </p>
      </div>
    </SlideUp>
