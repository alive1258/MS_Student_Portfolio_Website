        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <p className="mt-6 text-[20px] text-[#7C7C7C]">
              From undergraduate studies in electrical engineering to pursuing a
              Master’s degree and research assistantship, my path has always
              been centered around solving energy challenges. I’ve worked on
              simulation-heavy projects, hardware prototyping, and renewable
              energy modeling.
            </p>
            ...
            <div className="mt-6 space-y-2">
              <div className="flex items-center space-x-4">
                ...
                <p className="text-[#464646] text-[20px]">
                  Improving the efficiency and reliability of power electronic
                  converters{" "}
                </p>
              </div>
              <div className="flex items-center space-x-4">
